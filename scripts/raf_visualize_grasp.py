...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        # cv2.circle(img, grasp_point, 3, (0,0,255), 2)
        ...
        # Test of interaction point
        # interaction_point = (int((mid[0] + centroid[0]) / 2), int((mid[1] + centroid[1]) / 2))
        # cv2.circle(img, interaction_point, 2, (0,255,0), 4)
